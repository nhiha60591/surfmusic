    ...
    <div v-if="!showFilter">
      ...
      <div class="navigation px-4 mb-4">
        <ul class="flex text-white">
          ...
          <li class="mr-2"><router-link to="/playlist/mine" class="font-bold border-2 border-blue-primary  border-t-0 border-l-0 border-r-0 pb-2 px-4">Mine</router-link></li>
