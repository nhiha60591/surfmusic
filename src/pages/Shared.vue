  ...
  <div>
    ...
    <div class="navigation px-4 mb-4">
      <ul class="flex text-white mt-4">
        ...
        <li class="mr-2"><router-link to="/playlist/shared" class="font-bold border-2 border-blue-primary border-transparent border-t-0 border-l-0 border-r-0 pb-2 px-4">Shared</router-link></li>
