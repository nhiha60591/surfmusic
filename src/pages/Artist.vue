    ...
    <div v-if="!showFilter">
      ...
      <div class="navigation px-4 mb-4">
        <ul class="flex text-white">
          <li class="mr-2"><router-link to="/playlist" class="font-bold border-2 border-transparent border-t-0 border-l-0 border-r-0 pb-2 px-4">All</router-link></li>
          ...
          <li class="mr-2"><router-link to="/playlist/Shared" class="font-bold border-2  border-t-0 border-transparent border-l-0 border-r-0 pb-2 px-4">Shared</router-link></li>
          <li class="mr-2"><router-link to="/playlist/Artist" class="font-bold border-2 border-blue-primary  border-t-0 border-l-0 border-r-0 pb-2 px-4">Artist</router-link></li>
        </ul>
        </div>
        <div class="playlist-items flex w-full flex-wrap px-2">
          <PlaylistArtist v-for="n in 8" :key="`playlist-item-${n}`" />
        </div>>
      </div>
...
export default {
  components: { FilterForm, PlaylistArtist },
  data() {
    return {
      showFilter: false,
    }
